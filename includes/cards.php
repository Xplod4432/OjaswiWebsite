...
<a href="./blogpage.php?id=<?php echo $card_href; ?>">
    <div class="text-white lozad" style="position: relative; background: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), url(<?php echo $card_src; ?>); background-repeat: no-repeat; background-size: cover; min-height: 40vh; border-radius: 25px">
